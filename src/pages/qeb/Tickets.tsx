...
const OPEN_TICKETS: Ticket[] = [
  { id: 'ASN-4218', title: 'Filtro de reservas por fecha no responde',                                    priority: 'high', assignee: 'akary', created: '2026-08-07', age: '4h',  sla: 'warn' },
  { id: 'ASN-4217', title: 'Error 500 al aprobar arte digital sin thumbnail',                             priority: 'high', assignee: 'mario', created: '2026-08-07', age: '6h',  sla: 'warn' },
  { id: 'ASN-4215', title: 'Timeout en /api/reportes/aps con rangos > 3 catorcenas',                      priority: 'med',  assignee: 'akary', created: '2026-08-06', age: '1d',  sla: 'ok'   },
  { id: 'ASN-4212', title: 'Descarga de manual PDF falla en Safari iOS',                                   priority: 'low',  assignee: 'mario', created: '2026-08-06', age: '1d',  sla: 'ok'   },
  { id: 'ASN-4209', title: 'Modal de reemplazo no clona filas de artes_tradicionales',                    priority: 'med',  assignee: 'akary', created: '2026-08-05', age: '2d',  sla: 'warn' },
  { id: 'ASN-4204', title: 'Buscador de códigos no prioriza cercanía geográfica',                         priority: 'low',  assignee: 'jos',   created: '2026-08-04', age: '3d',  sla: 'crit' },
  { id: 'ASN-4198', title: 'Dashboard de inventario tarda >5s con >100 filtros activos',                  priority: 'med',  assignee: 'mario', created: '2026-08-02', age: '5d',  sla: 'crit' },
]
...
export default function Tickets() {
  ...
  const filtered = OPEN_TICKETS.filter((t) => filter === 'ALL' || t.priority === filter)
    ...
    <div className="flex flex-col gap-6 text-[13px]">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          { label: 'avg resolución', value: '18h',  accent: 'text-fg-primary' },
      ...
      {/* Workload */}
      <Section title="workload" subtitle="por atendedor · abiertos + cerrados 7d">
        <div className="mt-1">
          <div className="grid grid-cols-[140px_100px_120px_1fr] gap-3 px-2 py-1 text-[11px] text-fg-faint uppercase tracking-wide">
            ...
            <span className="text-right">closed 7d</span>
